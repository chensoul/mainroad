...
**[download ZIP](https://github.com/chensoul/mainroad/archive/master.zip)** and extract it into the `themes/mainroad`
...
**Do not copy the [example config](https://github.com/chensoul/mainroad#configtoml-example) as-is.**
...
To view our example configuration, visit [demo config](https://github.com/chensoul/mainroad/blob/master/exampleSite/config.toml).

[Edit this page on GitHub](https://github.com/chensoul/mainroad/blob/master/exampleSite/content/docs/getting-started.md)
